<!-- Footer -->
  <footer class="page-footer" style="font-family: Roboto;font-weight: 400;background: #826931">

    <!-- Social buttons -->
    <div class="" style="background-color: #c0a567">
      <div class="container">
        <!--Grid row-->
  ...
  <!-- SCRIPTS -->
          ...
          <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA3LOQAS97y1ctCLRMVl6NjMlcG6pLC_8o&callback=initMap">
          </script>
