...
<style type="text/css">
  ...
  <!--Mask-->
    <div id="about" class="view" style="height: 50%;background: url('img/hair-body-care.webp')no-repeat center center fixed;
      ...
      <div class="mask rgba-black-strong">
        <div class="container-fluid d-flex align-items-center justify-content-center h-100">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-md-10">
              <h2 class="text-center text-white h2-responsive px-2 py-3" style="font-family: 'Righteous';line-height: 1.4em"><b>Hair Care Products by Khadi Premium Cosmetics</b></h2>
  ...
  <div class="sidebar-nav my-3" style="background: #6b5523;">
    <div class="navbar navbar-default" role="navigation">
      ...
      <div class="navbar-collapse collapse sidebar-navbar-collapse">
        ...
        <li style="padding: 7.5px;"><a href="hair-care.php" class='text-white'>All Products</a></li>
        <?php getHairCare(); ?>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
