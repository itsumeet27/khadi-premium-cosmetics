      ...
      <div class="mask rgba-black-strong">
        <div class="container-fluid d-flex align-items-center justify-content-center h-100">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-md-10">
              <h2 class="text-center text-white h2-responsive px-2 py-3" style="font-family: 'Righteous';line-height: 1.4em"><b>Product Description</b></h2>
	...
	<div class="card p-3">
		<div class="">
			<div class="card-content">
				<div class="card-header" style="background: #6b5523;color: #fff;">								
								...
								<form action="add_cart.php" method="post" id="add_product_form">
									...
									<div class="form-group">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<label><b>Price:</b> &#8377; <?php echo $price; ?> <!-- &nbsp;<i class="text-danger" style="text-decoration: line-through;">&#8377;<?php echo $list_price; ?></i> --></label>
										</div>
									</div>
